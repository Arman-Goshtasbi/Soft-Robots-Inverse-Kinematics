...
%
% Author: Arman Goshtasbi (armangoshtasbi@gmail.com) 
%
%
...
%Inverse_Kinematics_final(desired path, length of each link ,number of segments , number of links ,plotting)
